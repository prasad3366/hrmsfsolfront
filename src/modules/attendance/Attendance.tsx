              ...
              <p className="text-slate-500 mb-6">Tap to record your attendance</p>
                <div className="flex justify-center gap-4">
                  ...
                  >
                    ...
                    {!todayRecord?.punchIn ? 'Check In' : !todayRecord?.punchOut ? 'Check Out' : 'View'}
                  </Button>
                </div>
                <div className="mt-6 flex flex-col items-center text-sm text-slate-500 gap-2">
                    ...
                    {todayRecord?.punchIn && (
                      <span>Check-In Time: {new Date(todayRecord.punchIn).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span>
                    )}
                </div>
            </div>
          </CardContent>
