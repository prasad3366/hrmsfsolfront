    ...
    <>
      <div className="min-h-screen bg-slate-50 font-sans overflow-x-hidden flex flex-col relative">
        ...
        <div className="absolute top-0 left-0 right-0 h-[50vh] z-0 transition-all duration-700 ease-in-out overflow-hidden">
          ...
          >
            <div className="absolute top-10 left-[10%] w-20 h-20 bg-purple-200/20 rounded-full blur-2xl animate-pulse" />
            <div className="absolute bottom-20 right-[10%] w-32 h-32 bg-violet-200/15 rounded-full blur-3xl" />
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-end justify-center w-full max-w-4xl gap-0">
            <div className="bg-white rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] p-6 w-full max-w-[360px] relative z-20">
              <div className="flex flex-col items-center mb-5">
                <img src={foodeezLogo} alt="FooDeeZ" className="h-20 w-auto mb-15" />
                <h2 className="text-2xl font-bold text-slate-800 text-center tracking-tight">Login</h2>
              </div>

              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1">
                  <label htmlFor="login-email" className="text-xs font-semibold text-slate-700 ml-1">
                ...
                <div className="space-y-1">
                  <label htmlFor="login-password" className="text-xs font-semibold text-slate-700 ml-1">
                ...
                {error && (
                  <div
                    className={`p-3 rounded-lg flex items-start gap-2 text-xs font-medium animate-in fade-in ${
